...
( function() {
					...
					elements: [ {
						...
						children: [ {
							...
							children: [ {
								...
								onChange: function() {
									var dialog = this.getDialog(),
										newUrl=ConvertFromGoogleDrive(this.getValue());										/////////////// CHANGE
	...
	//									http://localhost/ckeditor/plugins/image/images/noimage.png?t=H8DA

										if ( dialog.preview ) {
											// Query the preloader to figure out the url impacted by based href.
											previewPreloader.setAttribute( 'src', newUrl);	    								//////////// CHANGE	
								...
								commit: function( type, element ) {
									if ( type == IMAGE && ( this.getValue() || this.isChanged() ) ) {
											element.data( 'cke-saved-src',  ConvertFromGoogleDrive(this.getValue()) );				///////// CHANGE
										element.setAttribute( 'src',  ConvertFromGoogleDrive(this.getValue()) );					///////// CHANGE
